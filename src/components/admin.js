...
function _initVerification() {
    const discordInput = document.getElementById('admin-discord-id');
...
function _initAnnouncement() {
    const messageInput = document.getElementById('admin-announce-input');
    const authorInput = document.getElementById('admin-announce-author');
